  ...
  return (
    <div className="text-center selection:bg-green-900">
      <header className="bg-[#282c34] min-h-screen text-white flex flex-col justify-center items-center">
        ...
        <p className="text-5xl font-black bg-gradient-to-r from-emerald-300 to-sky-300 text-transparent bg-clip-text selection:bg-transparent">Vite + React + Tailwindcss v3</p>
        <p className="mt-3">
          <button
            type="button"
